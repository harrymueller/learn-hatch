...
#__version__ = version("harrymueller_epi_models")
...
def SIR_model(pop_size: int,
              beta: float,
              gamma: float,
              days: int,
              I_0: int) -> tuple[list[float],list[float],list[float]]:
    """
...
def main():
    ...
    parser.add_argument(
        "-o", "--output", default="SIR_model_plot.png",
